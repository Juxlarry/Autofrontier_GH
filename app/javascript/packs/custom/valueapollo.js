  ...
  [31],
  {
        ...
        f = function (e, t) {
          ...
          r.forEach(function (e) {
            (a = Object(n.a)({}, a, e.options, {
              ...
              (u = Object(n.a)({}, u, e.http));
          });
          var s = e.operationName,
            c = e.extensions,
            l = e.variables,
            f = e.query,
            h = { operationName: s, variables: l };
          return (
            u.includeExtensions && (h.extensions = c),
            u.includeQuery && (h.query = Object(o.a)(f)),
            { options: a, body: h }
          );
        },
        h = function (e, t) {
    ...
    6: function (e, t, r) {
      ...
      (function (e) {
        ...
        var P = { kind: "Field", name: { kind: "Name", value: "__typename" } };
        function A(e) {
        ...
        function ne(e, t, r) {
          return re(t) && re(e)
            ? (Object.isExtensible && !Object.isExtensible(e) && (e = oe(e, r)),
              Object.keys(t).forEach(function (n) {
                var o = t[n];
                if (Z.call(e, n)) {
                  var i = e[n];
    ...
    67: function (e, t, r) {
      ...
      var m = (function (e) {
        function t(t) {
          ...
          return (
            (u.queryName = s && s.name && s.name.value), (u.queryManager = r), u
          );
        }
        return (
          Object(o.c)(t, e),
          ...
          (t.prototype.getCurrentResult = function () {
            ...
            if (c) {
              ...
              if (
                ...
                r && (r.networkError || ("none" === i && p(r.graphQLErrors))))
              )
                return {
                  data: void 0,
                  loading: !1,
              ...
              c.variables &&
                ((this.options.variables = Object(o.a)(
                  Object(o.a)({}, this.options.variables),
                  c.variables
                )),
                (this.variables = this.options.variables)),
                (t = { data: u, loading: h(d), networkStatus: d }),
                c.graphQLErrors &&
            ...
            return (
              s ||
                this.updateLastResult(
                  Object(o.a)(Object(o.a)({}, t), { stale: !1 })
                ),
              Object(o.a)(Object(o.a)({}, t), { partial: s })
            );
          }),
            ...
            return "cache-only" === t
              ...
              : ("no-cache" !== t &&
                ...
                Object(a.a)(this.variables, e) ||
                  (this.variables = Object(o.a)(
                    Object(o.a)({}, this.variables),
                    e
                  )),
                ...
                this.queryManager.fetchQuery(
                  this.queryId,
                  Object(o.a)(Object(o.a)({}, this.options), {
                    fetchPolicy: t,
                  }),
                  b.refetch
                ));
          ...
          (t.prototype.fetchMore = function (e) {
            ...
            var r = Object(o.a)(
                Object(o.a)(
                  ...
                  e.query
                    ? e
                    : Object(o.a)(
                        Object(o.a)(Object(o.a)({}, this.options), e),
                        {
                          variables: Object(o.a)(
                            Object(o.a)({}, this.variables),
                            e.variables
                          ),
                        }
            ...
            return this.queryManager
              .fetchQuery(n, r, b.normal, this.queryId)
              .then(
                function (o) {
                  return (
          ...
          (t.prototype.setOptions = function (e) {
            var t = this.options.fetchPolicy;
            (this.options = Object(o.a)(Object(o.a)({}, this.options), e)),
              e.pollInterval
          ...
          (t.prototype.setUpQuery = function () {
            ...
            this.shouldSubscribe && t.addObservableQuery(r, this),
              this.options.pollInterval &&
                (j(this), t.startPollingQuery(this.options, r));
            var i = function (t) {
              e.updateLastResult(
                Object(o.a)(Object(o.a)({}, e.lastResult), {
              ...
              Object(o.b)(this, void 0, void 0, function () {
                ...
                return Object(o.d)(this, function (y) {
                  ...
                  return (
                    ...
                    [
                      2,
                      this.resolveSelectionSet(s.selectionSet, t, b).then(
                        function (e) {
                          return {
                            result: e,
        ...
        R = (function () {
          function e(e) {
            ...
            (this.mutationStore = new S()),
              ...
              (this.localState = h || new Q({ cache: o.getCache() })),
              (this.ssrMode = c),
          ...
          return (
                    ...
                    case 2:
                      return (
                        (u = function () {
                          ...
                          return (
                            a &&
                              d.queries.forEach(function (t, r) {
                  ...
                  switch (E.label) {
                    case 0:
                      return (
                        ...
                        (d = this.getVariables(h, t.variables)),
                        this.transform(h).hasClientExports
                          ? [4, this.localState.addExportedVariables(h, d, f)]
                          : [3, 2]
                      );
                    case 1:
                      (d = E.sent()), (E.label = 2);
                    case 2:
                      if (
                        ...
                        m ||
                          ...
                          (j = g.complete),
                          (S = g.result),
                          (O = !j || "cache-and-network" === c),
                          (p = S)),
                        (w = O && "cache-only" !== c && "standby" !== c),
                        Object(i.s)(["live"], h) && (w = !0),
                        (Q = this.idCounter++),
                        (k =
                          "no-cache" !== c
                        ...
                        if (
                          ((q = this.fetchRequest({
                            ...
                            throw v(t)
                              ? t
                              : (Q >= R.getQuery(e).lastRequestId &&
                                  (R.queryStore.markQueryError(e, t, n),
                                  R.invalidate(e),
                                  R.invalidate(n),
                                  R.broadcastQueries()),
                      ...
                      try {
                        ...
                        if (i)
                          ...
                          var j = u && u.getLastError(),
                            S =
                              "none" !== m &&
                              (j && j.graphQLErrors) !== r.graphQLErrors;
            ...
            (e.prototype.getVariables = function (e, t) {
              return Object(o.a)(
                Object(o.a)({}, this.transform(e).defaultVars),
                t
              );
            }),
              ...
              var a = function (e) {
                return t.getObservableFromLink(r, {}, e, !1).map(function (o) {
                  if (
                    ...
                    throw new y({ graphQLErrors: o.errors });
                  return o;
                });
              };
                ...
                var l = this.inFlightLinkObservables,
                  ...
                  h = {
                    ...
                    context: this.prepareContext(
                      Object(o.a)(Object(o.a)({}, t), { forceFetch: !n })
                    ),
                  };
                if (((t = h.context), n)) {
            ...
            (e.prototype.fetchRequest = function (e) {
              ...
              return new Promise(function (e, f) {
                ...
                var m = function () {
                    o.fetchQueryRejectFns.delete(b),
            ...
            (e.prototype.startPollingQuery = function (e, t, r) {
              ...
              if ((Object(l.b)(i, 18), !this.ssrMode)) {
                ...
                a || this.pollingInfoByQueryId.set(t, (a = {})),
                  (a.interval = i),
                  (a.options = Object(o.a)(Object(o.a)({}, e), {
                    fetchPolicy: "network-only",
                  }));
                var u = function () {
                    ...
                    e &&
                      (n.checkInFlight(t)
                        ? s()
                        : n.fetchQuery(t, e.options, b.poll).then(s, s));
                  },
                  s = function () {
                    var e = n.pollingInfoByQueryId.get(t);
                    e &&
        ...
        x = (function () {
          function e(e) {
            ...
            var r = e.cache,
              ...
              O = e.version,
              g = e.link;
            if ((!g && v && (g = s.ApolloLink.empty()), !g || !r))
              throw new l.a(4);
            (this.link = g),
              (this.cache = r),
              (this.store = new E(r)),
            ...
            (e.prototype.watchQuery = function (e) {
              return (
                this.defaultOptions.watchQuery &&
                  (e = Object(o.a)(
                    Object(o.a)({}, this.defaultOptions.watchQuery),
                    e
                  )),
            ...
            (e.prototype.query = function (e) {
              return (
                this.defaultOptions.query &&
                  (e = Object(o.a)(
                    Object(o.a)({}, this.defaultOptions.query),
                    e
                  )),
            ...
            (e.prototype.mutate = function (e) {
              return (
                this.defaultOptions.mutate &&
                  (e = Object(o.a)(
                    Object(o.a)({}, this.defaultOptions.mutate),
                    e
                  )),
          ...
          return (
            ...
            (e.prototype.writeData = function (e) {
              ...
              if ("undefined" !== typeof n) {
                var i = null;
                try {
                  i = this.read({ rootId: n, optimistic: !1, query: f });
                } catch (l) {}
              ...
              } else this.writeQuery({ query: s(o), data: o });
            }),
            e
          );
        })();
      ...
      var w = (function () {
        function e(e) {
          ...
          (this.freezeResults = a),
            (this.executeStoreQuery = Object(p.b)(
              function (e) {
                return s.call(t, e);
              },
              {
                makeCacheKey: function (e) {
                  var t = e.query,
                    ...
                    i = e.variableValues,
                    a = e.fragmentMatcher;
                  if (n.store instanceof j)
                    return o.lookup(n.store, t, a, JSON.stringify(i), r.id);
                },
              }
            )),
            (this.executeSelectionSet = Object(p.b)(
              function (e) {
                return c.call(t, e);
              },
              {
                makeCacheKey: function (e) {
                  var t = e.selectionSet,
                    r = e.rootValue,
                    n = e.execContext;
                  if (n.contextValue.store instanceof j)
                    return o.lookup(
            ...
            (this.executeSubSelectedArray = Object(p.b)(
              function (e) {
                return l.call(t, e);
              },
              {
        ...
        return (
          (e.prototype.readQueryFromStore = function (e) {
            return this.diffQueryAgainstStore(
              Object(n.a)(Object(n.a)({}, e), { returnPartialData: !1 })
            ).result;
          }),
                    ...
                    f &&
                      (c = f(e, n, {
                        getCacheKey: function (e) {
                          ...
                          return (
                            t && Object(u.H)({ id: t, typename: e.__typename })
                          );
                        },
                      }));
                  }
              ...
              o.selections.forEach(function (e) {
                ...
                if (Object(u.F)(e, a))
                  if (Object(u.t)(e)) {
                    ...
                    Object(u.v)(e)
                      ? (d = e)
                      : ((d = (c || {})[e.name.value]), Object(v.b)(d, 3));
                    var p = !0;
                    if (i.fragmentMatcherFunction && d.typeCondition) {
                      var b = n || "self",
                        y = Object(u.H)({ id: b, typename: void 0 }),
                        m = {
                          store: new R(((o = {}), (o[b] = r), o)),
                          cacheRedirects: {},
                        },
                        O = i.fragmentMatcherFunction(
                          y,
            ...
            if (i.selectionSet && null !== a)
              if (Array.isArray(a)) {
                ...
                if ((F(y) || (y = "$" + y), f)) {
                  var O = f(a);
                  Object(v.b)(!O || !F(O), 4),
                    (O || ("number" === typeof O && 0 === O)) &&
                      ((y = O), (m = !1));
                }
                D(y, i, c.processedData) ||
                ...
                var g = a.__typename;
                r = Object(u.H)({ id: y, typename: g }, m);
                var j = (o = h.get(s)) && o[p];
                if (j !== r && Object(u.u)(j)) {
                  var S = void 0 !== j.typename,
                    w = void 0 !== g,
                    Q = S && w && j.typename !== g;
                  Object(v.b)(!m || j.generated || Q, 5),
                    Object(v.b)(!S || w, 6),
                    j.generated &&
                      (Q
                        ? m || h.delete(j.id)
              ...
              r =
                null != a && "object" === typeof a
                  ? { type: "json", json: a }
                  : a;
            ((o = h.get(s)) && Object(d.a)(r, o[p])) ||
              h.set(s, Object(n.a)(Object(n.a)({}, o), (((t = {})[p] = r), t)));
          }),
          (e.prototype.processArrayValue = function (e, t, r, n) {
            ...
            return e.map(function (e, i) {
              ...
              return (
                ...
                Object(u.H)({ id: a, typename: e.__typename }, s)
              );
            });
          }),
          e
        ...
        V = (function (e) {
          function t(t) {
            ...
            (r.watches = new Set()),
              ...
              (r.cacheKeyRoot = new p.a(u.e)),
              (r.silenceBroadcast = !1),
              (r.config = Object(n.a)(Object(n.a)({}, C), t)),
              ...
              (r.data = r.config.resultCaching ? new j() : new R()),
            ...
            return (
              (r.maybeBroadcastWatch = Object(p.b)(
                function (e) {
                  return i.call(r, e);
                },
                {
          ...
          return (
            ...
            (t.prototype.removeOptimistic = function (e) {
              for (var t = [], r = 0, n = this.optimisticData; n instanceof L; )
        ...
        H = (function (e) {
          function t(t) {
            ...
            var r = t.request,
              ...
              O = t.cache;
            Object(v.b)(!O || !f, 1),
              O || (O = f ? new V({ cacheRedirects: f }) : new V());
            var g = B(
                h ||
                  function (e) {
            ...
            return (
              l &&
                (l.defaults && O.writeData({ data: l.defaults }),
                (Q = l.resolvers),
                (k = l.typeDefs),
                (q = l.fragmentMatcher)),
              e.call(this, {
        ...
        u = (function () {
          ...
          return (
            (e.prototype.enqueueRequest = function (e) {
              ...
              return (
                r.observable ||
                  (r.observable = new i.a(function (e) {
                    t.queuedRequests.has(a) || t.queuedRequests.set(a, []),
                      o || (t.queuedRequests.get(a).push(r), (o = !0)),
                      (r.next = r.next || []),
                      ...
                      1 === t.queuedRequests.get(a).length &&
                        t.scheduleQueueConsumption(a),
                      t.queuedRequests.get(a).length === t.batchMax &&
                        t.consumeQueue(a);
                  })),
                r.observable
              );
              ...
              if (r) {
                ...
                return (
                  l.subscribe({
                    next: function (e) {
                      if (
                        (Array.isArray(e) || (e = [e]), u.length !== e.length)
                      ) {
                        var t = new Error(
            ...
            (e.prototype.scheduleQueueConsumption = function (e) {
              var t = this,
                r = e || "";
              setTimeout(function () {
                t.queuedRequests.get(r) &&
                  t.queuedRequests.get(r).length &&
                  t.consumeQueue(r);
              }, this.batchInterval);
            }),
            e
                ...
                batchHandler: function (e) {
                  ...
                  if (r.clientAwareness) {
                    var s = r.clientAwareness,
                      c = s.name,
                      h = s.version;
                    c && (u["apollographql-client-name"] = c),
                      h && (u["apollographql-client-version"] = h);
                  }
                  var d,
                    p = {
                      http: r.http,
...
//# sourceMappingURL=m.apollo.8c2c578e.chunk.js.map
