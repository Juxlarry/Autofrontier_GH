...
class FuelTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fuel_type" do
    assert_difference('FuelType.count') do
      post fuel_types_url, params: { fuel_type: { comments: @fuel_type.comments, fuel_type: @fuel_type.fuel_type, status: @fuel_type.status } }
    end
  ...
  test "should update fuel_type" do
    patch fuel_type_url(@fuel_type), params: { fuel_type: { comments: @fuel_type.comments, fuel_type: @fuel_type.fuel_type, status: @fuel_type.status } }
