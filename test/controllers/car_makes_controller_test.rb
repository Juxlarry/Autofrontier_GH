...
class CarMakesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create car_make" do
    assert_difference('CarMake.count') do
      post car_makes_url, params: { car_make: { comments: @car_make.comments, name: @car_make.name, status: @car_make.status } }
    end
  ...
  test "should update car_make" do
    patch car_make_url(@car_make), params: { car_make: { comments: @car_make.comments, name: @car_make.name, status: @car_make.status } }
