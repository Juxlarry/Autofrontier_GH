...
class CarTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create car_type" do
    assert_difference('CarType.count') do
      post car_types_url, params: { car_type: { comments: @car_type.comments, name: @car_type.name, status: @car_type.status } }
    end
  ...
  test "should update car_type" do
    patch car_type_url(@car_type), params: { car_type: { comments: @car_type.comments, name: @car_type.name, status: @car_type.status } }
